...
func TestMetric(t *testing.T)     { fuzzGen(t, &metricGen{}, grader.GradingMultipleChoice) }
func TestOpenClosed(t *testing.T) { fuzzGen(t, &openClosedGen{}, grader.GradingMultipleChoice) }
func TestContinuous(t *testing.T) { fuzzGen(t, &continuousGen{}, grader.GradingMultipleChoice) }
