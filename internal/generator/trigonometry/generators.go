...
func Register(reg *generator.Registry) {
	reg.Register("trig.radians", &radiansGen{})
	reg.Register("trig.unit_circle", &unitCircleGen{})
	reg.Register("trig.sin_cos_def", &sinCosDefGen{})
	reg.Register("trig.tan_def", &tanDefGen{})
	reg.Register("trig.reciprocal", &reciprocalGen{})
	reg.Register("trig.pythagorean_id", &pythagoreanIDGen{})
	reg.Register("trig.special_angles", &specialAnglesGen{})
	reg.Register("trig.reference_angle", &referenceAngleGen{})
	reg.Register("trig.graph_sin", &graphSinGen{})
	reg.Register("trig.graph_cos", &graphCosGen{})
	reg.Register("trig.period", &periodGen{})
	reg.Register("trig.inverse", &inverseGen{})
	reg.Register("trig.law_sines", &lawSinesGen{})
	reg.Register("trig.law_cosines", &lawCosinesGen{})
}
