...
func TestCountCardinality(t *testing.T) {
	fuzzGen(t, &countCardinalityGen{}, grader.GradingNumeric, 100)
}
...
func TestSkip10(t *testing.T) {
	fuzzGen(t, &skipCountGen{step: 10, max: 100}, grader.GradingNumeric, 100)
}
func TestCountObjects20(t *testing.T) { fuzzGen(t, &countObjects20Gen{}, grader.GradingNumeric, 100) }
func TestCountOrdinal(t *testing.T) {
	fuzzGen(t, &countOrdinalGen{}, grader.GradingMultipleChoice, 100)
}
