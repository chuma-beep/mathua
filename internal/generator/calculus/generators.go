...
func Register(reg *generator.Registry) {
	...
	reg.Register("calc.deriv.cauchy_mvt", &generator.Stub{ConceptID: "calc.deriv.cauchy_mvt"})
	reg.Register("calc.deriv.convexity", &generator.Stub{ConceptID: "calc.deriv.convexity"})
	reg.Register("calc.deriv.difference_quotient", &generator.Stub{ConceptID: "calc.deriv.difference_quotient"})
	reg.Register("calc.deriv.differential", &generator.Stub{ConceptID: "calc.deriv.differential"})
	reg.Register("calc.deriv.fermat", &generator.Stub{ConceptID: "calc.deriv.fermat"})
	reg.Register("calc.deriv.mvt", &generator.Stub{ConceptID: "calc.deriv.mvt"})
	reg.Register("calc.deriv.non_differentiability", &generator.Stub{ConceptID: "calc.deriv.non_differentiability"})
	reg.Register("calc.deriv.partial", &generator.Stub{ConceptID: "calc.deriv.partial"})
	reg.Register("calc.deriv.rolle", &generator.Stub{ConceptID: "calc.deriv.rolle"})
	reg.Register("calc.integral.arc_length", &generator.Stub{ConceptID: "calc.integral.arc_length"})
	reg.Register("calc.integral.exp_integral", &generator.Stub{ConceptID: "calc.integral.exp_integral"})
	reg.Register("calc.integral.improper", &generator.Stub{ConceptID: "calc.integral.improper"})
	reg.Register("calc.integral.numerical", &generator.Stub{ConceptID: "calc.integral.numerical"})
	reg.Register("calc.integral.riemann_criteria", &generator.Stub{ConceptID: "calc.integral.riemann_criteria"})
	reg.Register("calc.integral.trig_integrals", &generator.Stub{ConceptID: "calc.integral.trig_integrals"})
	reg.Register("calc.integral.trig_substitution", &generator.Stub{ConceptID: "calc.integral.trig_substitution"})
	reg.Register("calc.integral.weierstrass_sub", &generator.Stub{ConceptID: "calc.integral.weierstrass_sub"})
	reg.Register("calc.limit.algebra", &generator.Stub{ConceptID: "calc.limit.algebra"})
	reg.Register("calc.limit.asymptotes", &generator.Stub{ConceptID: "calc.limit.asymptotes"})
	reg.Register("calc.limit.big_o", &generator.Stub{ConceptID: "calc.limit.big_o"})
	reg.Register("calc.limit.discontinuity", &generator.Stub{ConceptID: "calc.limit.discontinuity"})
	reg.Register("calc.limit.indeterminate", &generator.Stub{ConceptID: "calc.limit.indeterminate"})
	reg.Register("calc.limit.lhopital", &generator.Stub{ConceptID: "calc.limit.lhopital"})
	reg.Register("calc.limit.little_o", &generator.Stub{ConceptID: "calc.limit.little_o"})
	reg.Register("calc.limit.squeeze", &generator.Stub{ConceptID: "calc.limit.squeeze"})
	reg.Register("calc.limit.supremum", &generator.Stub{ConceptID: "calc.limit.supremum"})
	reg.Register("calc.limit.uniform_continuity", &generator.Stub{ConceptID: "calc.limit.uniform_continuity"})
	reg.Register("calc.limit.weierstrass", &generator.Stub{ConceptID: "calc.limit.weierstrass"})
	reg.Register("calc.seq.cauchy", &generator.Stub{ConceptID: "calc.seq.cauchy"})
	reg.Register("calc.seq.concept", &generator.Stub{ConceptID: "calc.seq.concept"})
	reg.Register("calc.seq.convergence", &generator.Stub{ConceptID: "calc.seq.convergence"})
	reg.Register("calc.seq.euler", &generator.Stub{ConceptID: "calc.seq.euler"})
	reg.Register("calc.seq.function_sequences", &generator.Stub{ConceptID: "calc.seq.function_sequences"})
	reg.Register("calc.seq.monotone", &generator.Stub{ConceptID: "calc.seq.monotone"})
	reg.Register("calc.series.alternating", &generator.Stub{ConceptID: "calc.series.alternating"})
	reg.Register("calc.series.cauchy_criterion", &generator.Stub{ConceptID: "calc.series.cauchy_criterion"})
	reg.Register("calc.series.concept", &generator.Stub{ConceptID: "calc.series.concept"})
	reg.Register("calc.series.fourier", &generator.Stub{ConceptID: "calc.series.fourier"})
	reg.Register("calc.series.function_series", &generator.Stub{ConceptID: "calc.series.function_series"})
	reg.Register("calc.series.harmonic", &generator.Stub{ConceptID: "calc.series.harmonic"})
	reg.Register("calc.series.integral_test", &generator.Stub{ConceptID: "calc.series.integral_test"})
	reg.Register("calc.series.positive_terms", &generator.Stub{ConceptID: "calc.series.positive_terms"})
	reg.Register("calc.series.power", &generator.Stub{ConceptID: "calc.series.power"})
	reg.Register("calc.series.root_test", &generator.Stub{ConceptID: "calc.series.root_test"})
	reg.Register("calc.series.taylor", &generator.Stub{ConceptID: "calc.series.taylor"})
}
