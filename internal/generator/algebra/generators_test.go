...
func TestFactorDiffSquares(t *testing.T)  { fuzzGen(t, &factorDiffSquaresGen{}, grader.GradingPolynomial) }
...
func TestQuadCompleteSquare(t *testing.T) { fuzzGen(t, &quadCompleteSquareGen{}, grader.GradingNumeric) }
