...
const domainOrder = [
  ...
  'linalg.cramer', 'linalg.lintrans', 'linalg.sys', 'linalg.systems',
  'prealg.eq', 'prealg.expr', 'prealg.ineq', 'prealg.real', 'prealg.types', 'prealg.var',
  'trig.adv', 'trig.basics', 'trig.eq', 'trig.graph_cos', 'trig.graph_sin', 'trig.hyperbolic', 'trig.ident', 'trig.ineq', 'trig.inverse', 'trig.law_cosines', 'trig.law_sines', 'trig.period', 'trig.pythagorean_id', 'trig.radians', 'trig.reciprocal', 'trig.reference_angle', 'trig.sin_cos_def',
]
