> Content sourced from [Algebrica](https://algebrica.org/rouche-capelli-theorem/) — CC BY-NC 4.0
...
\\[\begin{cases} 3x - y = 7 \\\\[6pt] x + 2y = 0 \end{cases} \\]
...
\\[\begin{cases} x_1 + x_2 - x_3 + 2x_4 = 1 \\\\[6pt] 2x_1 + 2x_2 + x_3 + x_4 = 5 \\\\[6pt] x_1 + x_2 + x_4 = 2 \end{cases} \\]

The augmented matrix is:

\\[A \mid \mathbf{b} = \begin{pmatrix} 1 & 1 & -1 & 2 & 1 \\\\[6pt] 2 & 2 & \phantom{-}1 & 1 & 5 \\\\[6pt] 1 & 1 & \phantom{-}0 & 1 & 2 \end{pmatrix} \\]

Reducing to row echelon form by replacing the second row with \\(R_2 - 2R_1\\) and the third row with \\(R_3 - R_1\\) gives:

\\[\begin{pmatrix} 1 & 1 & -1 & \phantom{-}2 & 1 \\\\[6pt] 0 & 0 & \phantom{-}3 & -3 & 3 \\\\[6pt] 0 & 0 & \phantom{-}1 & -1 & 1 \end{pmatrix} \\]

A further step \\(R_2 \to \tfrac{1}{3} R_2\\) followed by \\(R_3 \to R_3 - R_2\\) produces:

\\[\begin{pmatrix} 1 & 1 & -1 & \phantom{-}2 & 1 \\\\[6pt] 0 & 0 & \phantom{-}1 & -1 & 1 \\\\[6pt] 0 & 0 & \phantom{-}0 & \phantom{-}0 & 0 \end{pmatrix} \\]
...
\\[\begin{cases} x_1 = 2 - x_2 - x_4 \\\\[6pt] x_3 = 1 + x_4 \end{cases} \\]
...
\\[\begin{cases} x + 2y + z = 1 \\\\[6pt] 2x + y + 3z = 1 \\\\[6pt] 3x + 3y + 4z = 0 \end{cases} \\]

The coefficient matrix is:

\\[A = \begin{pmatrix} 1 & 2 & 1 \\\\[6pt] 2 & 1 & 3 \\\\[6pt] 3 & 3 & 4 \end{pmatrix} \\]
...
\\[A \mid \mathbf{b} = \begin{pmatrix} 1 & 2 & 1 & 1 \\\\[6pt] 2 & 1 & 3 & 1 \\\\[6pt] 3 & 3 & 4 & 0 \end{pmatrix} \\]
...
\\[\det \begin{pmatrix} 1 & 2 & 1 \\\\[6pt] 2 & 1 & 1 \\\\[6pt] 3 & 3 & 0 \end{pmatrix} = 3 \cdot (2 - 1) - 3 \cdot (1 - 2) + 0 = 3 + 3 = 6 \\]
...
\\[\begin{cases} k x + 2 y = 2 \\\\[6pt] 3 x + (k+1) y = 3 \end{cases} \\]
...
\\[A \mid \mathbf{b} = \begin{pmatrix} 2 & 2 & 2 \\\\[6pt] 3 & 3 & 3 \end{pmatrix} \\]
...
> A homogeneous system \\(A\mathbf{x} = \mathbf{0}\\) admits nontrivial solutions if and only if \\(r(A) < n\\). For square systems, where \\(m = n\\), this condition becomes \\(\det(A) = 0\\). For systems with fewer equations than unknowns, that is \\(m < n\\), the rank cannot exceed \\(m\\) and is therefore strictly less than \\(n\\). Such systems always admit nontrivial solutions.
