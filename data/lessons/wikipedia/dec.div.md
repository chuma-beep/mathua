...
More generally, a decimal with *n* digits after the separator (a point or comma) represents the fraction with denominator 10<sup>*n*</sup>, whose numerator is the integer obtained by removing the separator.
