...
In the diagram, let *R*<sub>1</sub> be the triangle *OAB*, *R*<sub>2</sub> the circular sector *OAB*, and *R*<sub>3</sub> the triangle *OAC*.
...
Using 1=cos<sup>2</sup>*θ* – 1 = –sin<sup>2</sup>*θ*,
...
Using the angle addition formula 1=sin(α+β) = sin α cos β + sin β cos α, we have:
...
Using the angle addition formula 1=cos(α+β) = cos α cos β – sin α sin β, we have:
\(\frac{\operatorname{d}}{\operatorname{d}\!\theta}\,\cos\theta
 =
...
Using the well-known angle formula 1=tan(α+β) = (tan α + tan β) / (1 - tan α tan β), we have:
\(\frac{\operatorname{d}}{\operatorname{d}\!\theta}\,\tan\theta
