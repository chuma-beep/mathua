...
V_y &= \int_a^b \pi x^2 \, \frac{dy}{dt} \, dt \,. \end{aligned}
\]
...
A_y &= \int_a^b 2 \pi x \, \sqrt{ \left( \frac{dx}{dt} \right)^2 + \left( \frac{dy}{dt} \right)^2} \, dt \,. \end{aligned}
\]
...
V_y &= \int_\alpha^\beta \left(\pi r^2\sin{\theta} \cos^2{\theta}\, \frac{dr}{d\theta}+\pi r^3\cos^3{\theta}\right)d\theta \,. \end{aligned}
\]
...
A_y &= \int_\alpha^\beta 2 \pi r\cos{\theta} \, \sqrt{ r^2 + \left( \frac{dr}{d\theta} \right)^2} \, d\theta \, \end{aligned}
\]
