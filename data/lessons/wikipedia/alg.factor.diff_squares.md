> Content sourced from [Wikipedia](https://en.wikipedia.org/wiki/Difference_of_two_squares) — CC BY-SA 4.0
...
The proof holds not only for numbers, but for elements of any commutative ring. Conversely, if this identity holds in a ring  for all pairs of elements  and , then  is commutative. To see this, apply the distributive law to the right-hand side of the equation and get
\(a^2 + ba - ab - b^2.\)
For this to be equal to , we must have
\(ba - ab = 0\)
for all pairs , , so  is commutative.
