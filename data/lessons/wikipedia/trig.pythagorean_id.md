...
In the expression for sin<sup>2</sup>,  must be at least 1, while in the expression for cos<sup>2</sup>, the constant term is equal to 1.  The remaining terms of their sum are (with common factors removed)
