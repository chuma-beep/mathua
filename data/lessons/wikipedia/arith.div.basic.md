...
#### Pseudoinverse
To avoid problems when *A*\(^{−1}\) and/or *B*\(^{−1}\) do not exist, division can also be defined as multiplication by the pseudoinverse. That is, *A* / *B* = *AB*\(^{+}\) and *A* \ *B* = *A*\(^{+}\)*B*, where *A*\(^{+}\) and *B*\(^{+}\) denote the pseudoinverses of and. ### Abstract algebra
