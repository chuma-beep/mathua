...
**Decimal fractions** (sometimes called **decimal numbers**, especially in contexts involving explicit fractions) are the  rational numbers that may be expressed as a fraction whose denominator is a power of ten. For example, the decimal expressions \(0.8, 14.89, 0.00079, 1.618, 3.14159\) represent the fractions {sfrac|8|10}, {sfrac|1489|100}, {sfrac|79|100000}, {sfrac||1618|1000} and {sfrac||314159|100000}, and therefore denote decimal fractions. An example of a fraction that cannot be represented by a decimal expression (with a finite number of digits) is {sfrac|1|3}, 3 not being a power of 10.
