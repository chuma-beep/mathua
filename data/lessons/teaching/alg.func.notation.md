...
1. Find $V(4)$.
2. Find $V(0)$.
3. Find $V\left(-\frac{1}{3}\right)$.

*Solution*
1. $\begin{aligned} V(4)\amp = -5(4)+1\\ \amp = -20+1 = -19 \end{aligned}$
2. $\begin{aligned} V(0)\amp = -5(0)+1\\ \amp = 0+1 = 1 \end{aligned}$
3. $\begin{aligned} V\left(\substitute{-\frac{1}{3}}\right)\amp = -5\left(\substitute{-\frac{1}{3}}\right)+1\\ \amp = \frac{5}{3}+1\\ \amp = \frac{5}{3}+\frac{3}{3} = \frac{8}{3} \end{aligned}$

**Example**
Let $L$ be the function defined by $L(z)=2z^2-z+3$. 
1. Find $L(1)$.
2. Find $L(-9)$.
3. Find $L\left(\frac{3}{2}\right)$.

*Solution*
1. $\begin{aligned} L(1) \amp =2(1)^2-(1)+3\\ \amp = 2(1)-1+3\\ \amp = 2-1+3=4 \end{aligned}$
2. $\begin{aligned} L(-9) \amp =2(-9)^2-(-9)+3\\ \amp = 2(81)+9+3\\ \amp = 162+9+3=174 \end{aligned}$
3. $\begin{aligned} L\left(\substitute{\frac{3}{2}}\right)\amp=2\left(\substitute{\frac{3}{2}}\right)^2-\left(\substitute{\frac{3}{2}}\right)+3\\ \amp = 2\left(\frac{9}{4}\right)-\frac{3}{2}+3\\ \amp = \frac{9}{2}-\frac{3}{2}+\frac{6}{2}\\ \amp = \frac{12}{2}=6 \end{aligned}$
