...
Any common divisor of $a$ and $b$ also divides $r = a - bq$, so $\gcd(a,b) = \gcd(b,r)$. The remainders get smaller each step, eventually reaching zero.
