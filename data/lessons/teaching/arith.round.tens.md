...
Money gives us a familiar model of place value. Suppose a wallet contains three $\text{\text{\$}100}$ bills, seven $\text{\text{\$}10}$ bills, and four $\text{\text{\$}1}$ bills. The amounts are summarized in Figure 1.3. How much money is in the wallet?

Figure  1.3

Find the total value of each kind of bill, and then add to find the total. The wallet contains $\text{\text{\$}374}.$
...
By looking at money and $\text{base-10}$ blocks, we saw that each place in a number has a different value. A place value chart is a useful way to summarize this information. The place values are separated into groups of three, called periods. The periods are _ones, thousands, millions, billions, trillions_ , and so on. In a written number, commas separate the periods.
...
Notice that the word _and_ is not used when naming a whole number.
...
A state budget was about $\text{\text{\$}77}$ billion. Write the budget in standard form.
...
So the budget was about $\text{\text{\$}77,000,000,000.}$
...
In $2013,$ the U.S. Census Bureau reported the population of the state of New York as $19,651,127$ people. It might be enough to say that the population is approximately $20$ million. The word _approximately_ means that $20$ million is not the exact population, but is close to the exact value.
...
**Writing a Check** Jorge bought a car for $\text{\text{\$}24,493}.$ He paid for the car with a check. Write the purchase price in words.

52. 

**Writing a Check** Marissa’s kitchen remodeling cost $\text{\text{\$}18,549}.$ She wrote a check to the contractor. Write the amount paid in words.

53. 

**Buying a Car** Jorge bought a car for $\text{\text{\$}24,493}.$ Round the price to the nearest:
...
**Remodeling a Kitchen** Marissa’s kitchen remodeling cost $\text{\text{\$}18,549}.$ Round the cost to the nearest:
