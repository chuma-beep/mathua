...
1.  Divide and reduce, if possible: $(4 + 5) \div (10 - 7).$  
    If you missed this problem, review Example 3.21.
2.  Multiply and write the answer in simplified form: $\frac{1}{8} \cdot \frac{2}{3}$.  
    If you missed this problem, review Example 4.25.
3.  Convert $2\frac{3}{5}$ into an improper fraction.  
...
| Look for common factors. | $\frac{2\not{} \cdot 5 \cdot 5}{3 \cdot 2\not{} \cdot 4}$ |
...
Multiply, and write your answer in simplified form: $2\frac{4}{5}\ \left( - 1\frac{7}{8} \right).$
...
| Convert mixed numbers to improper fractions. | $\frac{14}{5}\ \left( - \frac{15}{8} \right)$ |
...
Multiply, and write your answer in simplified form. $5\frac{5}{7}\ \left( - 2\frac{5}{8} \right).$
...
The words *quotient* and *ratio* are often used to describe fractions. In Subtract Whole Numbers, we defined quotient as the result of division. The quotient of $a\ \text{and}\ b$ is the result you get from dividing $a\ \text{by}\ b\ ,$ or $\frac{a}{b}.$ Let’s practice translating some phrases into algebraic expressions using these terms.

### Example 4.41

Translate the phrase into an algebraic expression: “the quotient of $3x$ and $8\text{."}$
...
| Look for common factors. | $\frac{3 \cdot 4\not{} \cdot 2}{4\not{} \cdot 5}$ |
...
| Look for common factors. | $- \frac{3\not{} \cdot 2 \cdot 1}{7 \cdot 3\not{}}$ |
...
| Look for common factors. | $\frac{{x\not{}} \cdot 3 \cdot 2\not{}}{2\not{} \cdot {x\not{}} \cdot y}$ |
...
$$
\frac{-1}{-3} = \frac{1}{3}\frac{\text{negative}}{\text{negative}} = \text{positive}
$$

### Placement of Negative Sign in a Fraction

For any positive numbers $a\ \text{and}\ b,$
...
The quotient of a positive and a negative is a negative, so $\frac{7}{-8}$ is negative. Of the fractions listed, $\frac{-7}{8}\ \text{and}\  - \frac{7}{8}$ are also negative.
...
2.  ⓑ Measuring cups usually come in sets with cups for $\frac{1}{8},\frac{1}{4},\frac{1}{3},\frac{1}{2},\text{and}\ 1$ cup. Draw a diagram to show two different ways that Graciela could measure out the flour needed to double the recipe.
