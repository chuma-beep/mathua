...
**Dirichlet's theorem:** If $\gcd(a,m)=1$, the arithmetic progression $a, a+m, a+2m,\dots$ contains infinitely many primes. Otherwise only finitely many (common divisor divides all terms).
...
Primes $\equiv1\bmod4$: $5,13,17,29,\dots$ infinite by Dirichlet with $a=1,m=4$.
