...
If you missed this problem, review Example 5.19.
  2. Order $0.64\;\;\;0.6$ using $<$ or $\text{>.}$  
If you missed this problem, review Example 5.7.
  3. Order $−0.2\;\;\;−0.1$ using $<$ or $\text{>.}$  
...
How do you know how many ‘repeats’ to write? Instead of writing $1.333…$ we use a shorthand notation by placing a line over the digits that repeat. The repeating decimal $1.333…$ is written $1.3- .$ The line above the $3$ tells you that the $3$ repeats endlessly. So $\text{1.333…}=1.3-$

For other decimals, two or more digits might repeat. Table 5.5 shows some more examples of repeating decimals.

$\text{1.333…}=1.3-$ | $3$ is the repeating digit  
---|---  
$\text{4.1666…}=4.16-$ | $6$ is the repeating digit  
$\text{4.161616…}=4.16\text{—}$ | $16$ is the repeating block  
$\text{0.271271271…}=0.271\text{---}$ | $271$ is the repeating block  
...
Order $\frac{3}{8}\;\;\;0.4$ using $<$ or $\text{>.}$

####  Solution

| $\frac{3}{8}\;\;\;0.4$  
---|---  
Convert $\frac{3}{8}$ to a decimal. | $0.375\;\;\;0.4$  
...
Order $−0.5\;\;\;- \frac{3}{4}$ using $<$ or $\text{>.}$

####  Solution

| $−0.5\;\;\;- \frac{3}{4}$  
---|---  
Convert $- \frac{3}{4}$ to a decimal. | $−0.5\;\;\;−0.75$  
...
Write the smallest decimal number first. | $0.61,\;\;\;,\;\;\;$  
Write the next larger decimal number in the middle place. | $0.61,0.65,\;\;\;$  
...
If we want the exact circumference or area of a circle, we leave the symbol $π$ in the answer. We can get an approximate answer by substituting $3.14$ as the value of $\text{π}.$ We use the symbol $\approx$ to show that the result is approximate, not exact.

###  Properties of Circles

$\begin{array}{c}r\ \text{is the length of the radius.} \\ d\ \text{is the length of the diameter.}\end{array}$

$\begin{array}{cccc}\text{The circumference is}\ 2\text{π}\text{r}. & & & C=2\text{π}\text{r} \\ \text{The area is}\ \text{π}\text{r}^{2}. & & & A=\ \text{π}\text{r}^{2}\end{array}$

Since the diameter is twice the radius, another way to find the circumference is to use the formula $C=\ \text{π}\text{d}.$
...
$\begin{array}{c} \\ A=\ \text{π}\text{r}^{2} \\ A=\ \text{π}\text{(}10^{2}\text{)} \\ A=π\cdot 100\end{array}$

We write $π$ after the $100.$ So the exact value of the area is $A=100\text{π}$ square inches.

To approximate the area, we would substitute $π\approx 3.14.$

$\begin{array}{ccc} A & = & 100 \text{π} \\ & & \\ & \approx & 100 \cdot 3.14 \\ & \approx & 314 \ \text{square inches} \end{array}$
...
---|---  
Write the formula for circumference. | $C=2\text{π}\text{r}$  
Substitute 3.14 for $π$ and 10 for ,$r$. | $C\approx 2(3.14)(10)$  
Multiply. | $C\approx 62.8\ \text{centimeters}$  

ⓑ Find the area when $r=10.$ |   
---|---  
Write the formula for area. | $A=\ \text{π}\text{r}^{2}$  
Substitute 3.14 for $π$ and 10 for $r$. | $A\approx (3.14)\text{(}10\text{)}^{2}$  
...
---|---  
Write the formula for circumference. | $C=2\text{π}\text{r}$  
Substitute 3.14 for $π$ and 42.5 for $r$ | $C\approx 2(3.14)(42.5)$  
Multiply. | $C\approx 266.9\ \text{centimeters}$  

ⓑ Find the area when $r=42.5$. |   
---|---  
Write the formula for area. | $A=\ \text{π}\text{r}^{2}$  
Substitute 3.14 for $π$ and 42.5 for $r$. | $A\approx (3.14)\text{(}42.5\text{)}^{2}$  
...
---|---  
Write the formula for circumference. | $C=2\text{π}\text{r}$  
Substitute $\frac{22}{7}$ for $π$ and $\frac{14}{15}$ for $r$. | $C\approx 2(\frac{22}{7})(\frac{14}{15})$  
Multiply. | $C\approx \frac{88}{15}\ \text{meters}$  

ⓑ Find the area when $r=\frac{14}{15}.$ |   
---|---  
Write the formula for area. | $A=\ \text{π}\text{r}^{2}$  
Substitute $\frac{22}{7}$ for $π$ and $\frac{14}{15}$ for $r$. | $A\approx (\frac{22}{7})\text{(}\frac{14}{15}\text{)}^{2}$  
...
Kelly wants to buy a pair of boots that are on sale for $\frac{2}{3}$ of the original price. The original price of the boots is $\text{\text{\$}84.99}.$ What is the sale price of the shoes?
