...
####  Add or subtract decimals.
  ...
  1. Step 1.  Write the numbers vertically so the decimal points line up.
...
| $3.7+12.4$  
---|---  
Write the numbers vertically so the decimal points line up. | $\begin{array}{c}3.7 \\ +12.4\end{array}$  
Place holders are not needed since both numbers have the same number of decimal places. |   
Add the numbers as if they were whole numbers. Then place the decimal in the answer under the decimal points in the given numbers. | $\begin{array}{c}31.7 \\ +12.4 \\ 16.1\end{array}$  
...
How much change would you get if you handed the cashier a $\text{\text{\$}20}$ bill for a $\text{\text{\$}14.65}$ purchase? We will show the steps to calculate this in the next example.
...
####  Multiply decimal numbers.
  ...
  2. Step 2.  Write the numbers in vertical format, lining up the numbers on the right.
  3. Step 3.  Multiply the numbers as if they were whole numbers, temporarily ignoring the decimal points.
  4. Step 4.  Place the decimal point. The number of decimal places in the product is the sum of the number of decimal places in the factors. If needed, use zeros as placeholders.
  5. Step 5.  Write the product with the appropriate sign.
...
Write in vertical format, lining up the numbers on the right. | $\begin{array}{c}5.19 \\ \times 8.2\end{array}$  
Multiply. | $\begin{array}{c}5.19 \\ \times 8.2 \\ 1038 \\ 4152 \\ 42558\end{array}$   
| $\begin{array}{c}5.19 \\ \times 8.2 \\ 1038 \\ 4152 \\ 42.558\end{array}$  
...
$\begin{array}{ccc}1.9436(10) & = & 19.436 \\ 1.9436(100) & = & 194.36 \\ 1.9436(1000) & = & 1943.6\end{array}$
...
####  Divide a decimal by a whole number.
  ...
  1. Step 1.  Write as long division, placing the decimal point in the quotient above the decimal point in the dividend.
  2. Step 2.  Divide as usual.
...
In everyday life, we divide whole numbers into decimals—money—to find the price of one item. For example, suppose a case of $24$ water bottles cost $\text{\text{\$}3.99}.$ To find the price per water bottle, we would divide $\text{\text{\$}3.99}$ by $24,$ and round the answer to the nearest cent (hundredth).

###  Example  5.20

Divide: $\text{\text{\$}3.99}\div 24.$
...
Round to the nearest cent. | $\text{\$}0.166\approx \text{\$}0.17$  
| $\text{\$}3.99\div 24\approx \text{\$}0.17$  

This means the price per bottle is $17$ cents.

###  Try It  5.39

Divide: $\text{\text{\$}6.99}\div 36.$

###  Try It  5.40

Divide: $\text{\text{\$}4.99}\div 12.$
...
$\begin{array}{c}\frac{0.8}{0.2} \\ \\ \frac{(0.8)10}{(0.2)10} \\ \\ \frac{8}{2} \\ \\ 4\end{array}$
...
####  Divide decimal numbers.
  ...
  2. Step 2.  Make the divisor a whole number by moving the decimal point all the way to the right. Move the decimal point in the dividend the same number of places to the right, writing zeros as needed.
...
We can relate this example to money. How many nickels are there in four dollars? Because $4\div 0.05=80,$ there are $80$ nickels in $\text{\text{\$}4}.$
...
Paul received $\text{\text{\$}50}$ for his birthday. He spent $\text{\text{\$}31.64}$ on a video game. How much of Paul’s birthday money was left?
...
Nicole earned $\text{\text{\$}35}$ for babysitting her cousins, then went to the bookstore and spent $\text{\text{\$}18.48}$ on books and coffee. How much of her babysitting money was left?

###  Try It  5.48

Amber bought a pair of shoes for $\text{\text{\$}24.75}$ and a purse for $\text{\text{\$}36.90}.$ The sales tax was $\text{\text{\$}4.32}.$ How much did Amber spend?

###  Example  5.25

Jessie put $8$ gallons of gas in her car. One gallon of gas costs $\text{\text{\$}3.529}.$ How much does Jessie owe for the gas? (Round the answer to the nearest cent.)
...
Hector put $13$ gallons of gas into his car. One gallon of gas costs $\text{\text{\$}3.175}.$ How much did Hector owe for the gas? Round to the nearest cent.

###  Try It  5.50

Christopher bought $5$ pizzas for the team. Each pizza cost $\text{\text{\$}9.75}.$ How much did all the pizzas cost?

###  Example  5.26

Four friends went out for dinner. They shared a large pizza and a pitcher of soda. The total cost of their dinner was $\text{\text{\$}31.76}.$ If they divide the cost equally, how much should each friend pay?
...
Translate to an expression. | $\text{\$}31.76\div 4$  
Simplify. | $7.94  
Write a sentence. | Each friend should pay $7.94 for his share of the dinner.  

###  Try It  5.51

Six friends went out for dinner. The total cost of their dinner was $\text{\text{\$}92.82}.$ If they divide the bill equally, how much should each friend pay?

###  Try It  5.52

Chad worked $40$ hours last week and his paycheck was $\text{\text{\$}570}.$ How much does he earn per hour?

Be careful to follow the order of operations in the next example. Remember to multiply before you add.

###  Example  5.27

Marla buys $6$ bananas that cost $\text{\text{\$}0.22}$ each and $4$ oranges that cost $\text{\text{\$}0.49}$ each. How much is the total cost of the fruit?
...
Translate to an expression. | $6(\text{\$}0.22)+4(\text{\$}0.49)$  
Simplify. | $\text{\$}1.32+\text{\$}1.96$  
Add. | $3.28  
Write a sentence. | Marla's total cost for the fruit is $3.28.  

###  Try It  5.53

Suzanne buys $3$ cans of beans that cost $\text{\text{\$}0.75}$ each and $6$ cans of corn that cost $\text{\text{\$}0.62}$ each. How much is the total cost of these groceries?

###  Try It  5.54

Lydia bought movie tickets for the family. She bought two adult tickets for $\text{\text{\$}9.50}$ each and four children’s tickets for $\text{\text{\$}6.00}$ each. How much did the tickets cost Lydia in all?

###  Links To Literacy

The _Links to Literacy_ activity "Alexander Who Used to be Rich Last Sunday" will provide you with another view of the topics covered in this section. 
...
$\text{\text{\$}117.25} \div 48$

150. 

$\text{\text{\$}109.24} \div 36$
...
$\text{\text{\$}45} + 0.08 ( \text{\text{\$}45} )$

170. 

$\text{\text{\$}63} + 0.18 ( \text{\text{\$}63} )$
...
$[ \text{\text{\$}75.42} + 0.18 ( \text{\text{\$}75.42} ) ] \div 5$

176. 

$[ \text{\text{\$}56.31} + 0.22 ( \text{\text{\$}56.31} ) ] \div 4$
...
**Spending money** Brenda got $\text{\text{\$}40}$ from the ATM. She spent $\text{\text{\$}15.11}$ on a pair of earrings. How much money did she have left?

178. 

**Spending money** Marissa found $\text{\text{\$}20}$ in her pocket. She spent $\text{\text{\$}4.82}$ on a smoothie. How much of the $\text{\text{\$}20}$ did she have left?

179. 

**Shopping** Adam bought a t-shirt for $\text{\text{\$}18.49}$ and a book for $\text{\text{\$}8.92}$ The sales tax was $\text{\text{\$}1.65}.$ How much did Adam spend?

180. 

**Restaurant** Roberto’s restaurant bill was $\text{\text{\$}20.45}$ for the entrée and $\text{\text{\$}3.15}$ for the drink. He left a $\text{\text{\$}4.40}$ tip. How much did Roberto spend?

181. 

**Coupon** Emily bought a box of cereal that cost $\text{\text{\$}4.29}.$ She had a coupon for $\text{\text{\$}0.55}$ off, and the store doubled the coupon. How much did she pay for the box of cereal?

182. 

**Coupon** Diana bought a can of coffee that cost $\text{\text{\$}7.99}.$ She had a coupon for $\text{\text{\$}0.75}$ off, and the store doubled the coupon. How much did she pay for the can of coffee?
...
**Coffee** Noriko bought $4$ coffees for herself and her co-workers. Each coffee was $\text{\text{\$}3.75}.$ How much did she pay for all the coffees?

186. 

**Subway Fare** Arianna spends $\text{\text{\$}4.50}$ per day on subway fare. Last week she rode the subway $6$ days. How much did she spend for the subway fares?

187. 

**Income** Mayra earns $\text{\text{\$}9.25}$ per hour. Last week she worked $32$ hours. How much did she earn?

188. 

**Income** Peter earns $\text{\text{\$}8.75}$ per hour. Last week he worked $19$ hours. How much did he earn?

189. 

**Hourly Wage** Alan got his first paycheck from his new job. He worked $30$ hours and earned $\text{\text{\$}382.50}.$ How much does he earn per hour?

190. 

**Hourly Wage** Maria got her first paycheck from her new job. She worked $25$ hours and earned $\text{\text{\$}362.50}.$ How much does she earn per hour?

191. 

**Restaurant** Jeannette and her friends love to order mud pie at their favorite restaurant. They always share just one piece of pie among themselves. With tax and tip, the total cost is $\text{\text{\$}6.00}.$ How much does each girl pay if the total number sharing the mud pie is
...
**Pizza** Alex and his friends go out for pizza and video games once a week. They share the cost of a $\text{\text{\$}15.60}$ pizza equally. How much does each person pay if the total number sharing the pizza is
...
**Fast Food** At their favorite fast food restaurant, the Carlson family orders $4$ burgers that cost $\text{\text{\$}3.29}$ each and $2$ orders of fries at $\text{\text{\$}2.74}$ each. What is the total cost of the order?

194. 

**Home Goods** Chelsea needs towels to take with her to college. She buys $2$ bath towels that cost $\text{\text{\$}9.99}$ each and $6$ washcloths that cost $\text{\text{\$}2.99}$ each. What is the total cost for the bath towels and washcloths?

195. 

**Zoo** The Lewis and Chousmith families are planning to go to the zoo together. Adult tickets cost $\text{\text{\$}29.95}$ and children’s tickets cost $\text{\text{\$}19.95}.$ What will the total cost be for $4$ adults and $7$ children?

196. 

**Ice Skating** Jasmine wants to have her birthday party at the local ice skating rink. It will cost $\text{\text{\$}8.25}$ per child and $\text{\text{\$}12.95}$ per adult. What will the total cost be for $12$ children and $3$ adults?

#### Everyday Math

197. 

**Paycheck** Annie has two jobs. She gets paid $\text{\text{\$}14.04}$ per hour for tutoring at City College and $\text{\text{\$}8.75}$ per hour at a coffee shop. Last week she tutored for $8$ hours and worked at the coffee shop for $15$ hours.
...
**Paycheck** Jake has two jobs. He gets paid $\text{\text{\$}7.95}$ per hour at the college cafeteria and $\text{\text{\$}20.25}$ at the art gallery. Last week he worked $12$ hours at the cafeteria and $5$ hours at the art gallery.
