...
---|---  
Rewrite the numerator and denominator as the product of the primes. | $\frac{210}{385}=\frac{2⋅3⋅5⋅7}{5⋅7⋅11}$  
Remove the common factors. |   
Simplify. | $\frac{2⋅3}{11}$  
...
| $- \frac{5}{8}(- \frac{2}{3})$  
---|---  
The signs are the same, so the product is positive. Multiply the numerators, multiply the denominators. | $\frac{5⋅2}{8⋅3}$  
Simplify. | $\frac{10}{24}$  
...
| $- \frac{5}{8}(- \frac{2}{3})$  
---|---  
Determine the sign of the product. Multiply. | $\frac{5⋅2}{8⋅3}$  
...
$\frac{2}{3}\cdot \frac{3}{2}=1\ \text{and}\ - \frac{10}{7}(- \frac{7}{10})=1$
