...
$- \frac{5}{16} + \left( {- \frac{9}{16}} \right)$
...
$- \frac{8}{11} - \left( {- \frac{5}{11}} \right)$
...
Bits in case: $\frac{1}{16}$, $\frac{1}{8}$, \_\_\_, \_\_\_, $\frac{5}{16}$, $\frac{3}{8}$, \_\_\_, $\frac{1}{2}$, $\frac{9}{16}$, $\frac{5}{8}$.  
