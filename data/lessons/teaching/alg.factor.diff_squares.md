...
$$
\begin{aligned}(x-b)(x+b)&=x^2-bx+bx-b^2 \\ &=x^2-b^2\end{aligned}
$$
...
. And so if we ever encounter a polynomial of the form $x^2-b^2$ (a "difference of squares") then we have a quick formula for factoring it. Just identify what "$b$" is, and use that in $(x-b)(x+b)$.
...
$$
\begin{aligned}(A+B)^2&=(A+B)(A+B) \\ &=A^2+BA+AB+B^2 \\ &=A^2+2AB+B^2\end{aligned}
$$
...
. Now we have two factors. There is nothing for us to do with $3z$, but we should ask if $\left(4z^2-9\right)$ can factor further. And in fact, that is a difference of squares. So we can apply   . The full process would be:
