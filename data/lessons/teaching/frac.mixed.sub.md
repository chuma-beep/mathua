...
$\begin{array}{c} \\ \\ \\ \ 1\frac{1}{4} \\ +2\frac{1}{4} \\ \text{} \\ \\ \\ \ 3\frac{2}{4}=3\frac{1}{2}\end{array}$
...
$\begin{array}{c} \\ 9\frac{5}{9} \\ +\ 5\frac{7}{9} \\ 14\frac{12}{9}\end{array}$   
...
---|---  
$\begin{array}{c} \\ \\ \ 3\frac{2}{5} \\ \frac{+6\frac{4}{5}}{\ 9\frac{6}{5}} \\ 9+\frac{6}{5} \\ 9+1\frac{1}{5} \\ 10\frac{1}{5}\end{array}$ | $\begin{array}{c} \\ 3\frac{2}{5}+6\frac{4}{5} \\ \frac{17}{5}+\frac{34}{5} \\ \frac{51}{5} \\ 10\frac{1}{5}\end{array}$  
...
What if you start with a mixed number and need to subtract a fraction? Think about this situation: You need to put three quarters in a parking meter, but you have only a $\text{\text{\$}1}$ bill and one quarter. What could you do? You could change the dollar bill into $4$ quarters. The value of $4$ quarters is the same as one dollar bill, but the $4$ quarters are more useful for the parking meter. Now, instead of having a $\text{\text{\$}1}$ bill and one quarter, you have $5$ quarters and can put $3$ quarters in the meter.
...
Edgar will have to pay $\text{\text{\$}3.75}$ in tolls to drive to the city.

ⓐ Explain how he can make change from a $\text{\text{\$}10}$ bill before he leaves so that he has the exact amount he needs.
