...
1. The federal debt climbed by $1.42$ trillion dollars in 2016.
2. The federal debt was $19.6$ trillion dollars at the close of business on Sept. 30, 2016.
...
Through centuries of scientific progress, humanity became increasingly aware of very large numbers and very small measurements. As one example, the star that is nearest to our sun is https://imagine.gsfc.nasa.gov/features/cosmic/nearest_star_info.html. Proxima Centauri is about $25{,}000{,}000{,}000{,}000$ miles from our sun. Again, many will find the descriptive language easier to read: Proxima Centauri is about $25$ trillion miles from our sun.
...
**Example**
On Sept. 30th, 2016, the https://www.census.gov/popclock was about $\$19{,}600{,}000{,}000{,}000$ and the US population was about $323{,}000{,}000$. What was the average debt per person that day? 
...
1. We may need to use a calculator to handle such large numbers and we have to be careful that we type the correct number of `0` s. $\begin{aligned} \frac{19600000000000}{323000000}\approx 60681.11 \end{aligned}$
2. To perform this calculation using scientific notation, our work would begin by setting up the quotient as $\frac{1.96 \times 10^{13}}{3.23 \times 10^8}$. Dividing this quotient follows the same process we did with variable expressions of the same format, such as $\frac{1.96 w^{13}}{3.23 w^8}$. In both situations, we'll divide the coefficients and then use exponent properties to simplify the powers. $\begin{aligned} \frac{1.96 \times 10^{13}}{3.23 \times 10^8} &= \frac{1.96 }{3.23} \times\frac{10^{13}}{ 10^8} \\ &\approx 0.6068111 \times 10^5 \\ &\approx 60681.11 \end{aligned}$
...
1. $\begin{aligned}[t] \left( 2\times 10^5 \right)\left( 3\times10^4 \right) \amp= \left( 2\times 3 \right)\times \left(10^5 \times 10^4 \right)\\ \amp= 6 \times 10^{9} \end{aligned}$
2. $\begin{aligned}[t] \frac{8 \times 10^{17}}{4\times 10^2} \amp= \frac{8}{4} \times \frac{10^{17}}{10^2}\\ \amp= 2 \times 10^{15} \end{aligned}$
...
1. $\left( 8 \times 10^{21} \right)\left( 2 \times 10^{-7} \right)$
2. $\dfrac{ 2 \times 10^{-6} }{ 8 \times 10^{-19} }$
...
1. $\begin{aligned}[t] \left( 8 \times 10^{21} \right)\left( 2 \times 10^{-7} \right) \amp= \left( 8 \times 2 \right)\times\left( 10^{21} \times 10^{-7} \right)\\ \amp= \highlight{16} \times 10^{14}\\ \amp= \highlight{1.6\times 10^1} \times 10^{14}\\ \amp= 1.6 \times 10^{15} \end{aligned}$ We need to remember to apply the product property for exponents to the powers of ten.
2. $\begin{aligned}[t] \frac{ 2 \times 10^{-6} }{ 8 \times 10^{-19} } \amp= \frac{ 2 }{ 8 }\times\frac{ 10^{-6} }{ 10^{-19} }\\ \amp= \highlight{0.25} \times 10^{13}\\ \amp= \highlight{2.5\times 10^{-1}} \times 10^{13}\\ \amp= 2.5 \times 10^{12} \end{aligned}$
