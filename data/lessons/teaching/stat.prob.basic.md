...
One application of decimals that arises often is finding the _average_ of a set of numbers. What do you think of when you hear the word _average_? Is it your grade point average, the average rent for an apartment in your city, the batting average of a player on your favorite baseball team? The average is a typical value in a set of numerical data. Calculating an average sometimes involves working with decimal numbers. In this section, we will look at three different ways to calculate an average.
...
$\begin{array}{c} \\ \frac{85+88+94}{3} \\ \frac{267}{3} \\ 89\end{array}$
...
$\text{mean}=\frac{\text{sum of values in data set}}{n}$
  ...
  2. Step 2.  Find the sum of all the values in the set. Write the sum in the numerator.
  3. Step 3.  Count the number, $n,$ of values in the set. Write this number in the denominator.
  4. Step 4.  Simplify the fraction.
  5. Step 5.  Check to see that the mean is reasonable. It should be greater than the least number and less than the greatest number in the set.
...
The ages of the four students in Ben’s carpool are $25,18,21,\text{and}\ 22.$ Find the mean age of the students.
...
For the past four months, Daisy’s cell phone bills were $\text{\text{\$}42.75},\text{\text{\$}50.12},\text{\text{\$}41.54},\text{\text{\$}48.15}.$ Find the mean cost of Daisy’s cell phone bills.
...
Does $\text{\text{\$}45.64}$ seem ‘typical’ of this set of numbers? Yes, it is neither less than $\text{\text{\$}41.54}$ nor greater than $\text{\text{\$}50.12}.$

The mean cost of her cell phone bill was $\text{\text{\$}45.64}$

###  Try It  5.101

Last week Ray recorded how much he spent for lunch each workday. He spent $\text{\text{\$}6.50},\text{\text{\$}7.25},\text{\text{\$}4.90},\text{\text{\$}5.30},\text{and}\ \text{\text{\$}12.00}.$ Find the mean of how much he spent each day.

###  Try It  5.102

Lisa has kept the receipts from the past four trips to the gas station. The receipts show the following amounts: $\text{\text{\$}34.87},\text{\text{\$}42.31},\text{\text{\$}38.04},\text{and}\ \text{\text{\$}43.26}.$ Find the mean.
...
Dora is in the middle of the group. Her height, $65\text{″},$ is the _median_ of the girls’ heights. Half of the heights are less than or equal to Dora’s height, and half are greater than or equal. The median is the middle value.
...
Find the mean of 85 and 86. | $\text{mean}=\frac{85+86}{2}$  
| $\text{mean}=85.5$  
...
####  Identify the mode of a set of numbers.
  ...
  1. Step 1.  List the data values in numerical order.
  2. Step 2.  Count the number of times each value appears.
  3. Step 3.  The mode is the value with the highest frequency.
...
$\begin{array}{c} \\ \text{Probability of choosing a banana}=\frac{3}{5} \\ \text{Probability of choosing a banana}=0.6\end{array}$
...
Use the definition of probability. | $\text{Probability of an event}=\frac{\text{number of favorable outcomes}}{\text{total number of outcomes}}$  
Substitute into the numerator and denominator. | $\text{Probability Cherie wins}=\frac{1}{100}$  

ⓑ |   
---|---  
Convert the fraction to a decimal. |   
Write the probability as a fraction. | $\text{Probability}=\frac{1}{100}$  
Convert the fraction to a decimal. | $\text{Probability}=0.01$  
...
Use the definition of probability. | $\text{Probability of an event}=\frac{\text{number of favorable outcomes}}{\text{total number of outcomes}}$  
Substitute into the numerator and denominator. | $\text{Probability}=\frac{3}{8}$  

ⓑ |   
---|---  
Convert the fraction to a decimal. |   
Write the probability as a fraction. | $\text{Probability}=\frac{3}{8}$  
Convert the fraction to a decimal. | $\text{Probability}=0.375$  
...
Four girls leaving a mall were asked how much money they had just spent. The amounts were $\text{\text{\$}0}$, $\text{\text{\$}14.95}$, $\text{\text{\$}35.25}$, and $\text{\text{\$}25.16}$. Find the mean amount of money spent.

366. 

Juan bought $5$ shirts to wear to his new job. The costs of the shirts were $\text{\text{\$}32.95}$, $\text{\text{\$}38.50}$, $\text{\text{\$}30.00}$, $\text{\text{\$}17.45}$, and $\text{\text{\$}24.25}$. Find the mean cost.
...
Norris bought six books for his classes this semester. The costs of the books were $\text{\text{\$}74.28}$, $\text{\text{\$}120.95}$, $\text{\text{\$}52.40}$, $\text{\text{\$}10.59}$, $\text{\text{\$}35.89}$, and $\text{\text{\$}59.24}$. Find the mean cost.
...
Last week Ray recorded how much he spent for lunch each workday. He spent $\text{\text{\$}6.50}$, $\text{\text{\$}7.25}$, $\text{\text{\$}4.90}$, $\text{\text{\$}5.30}$, and $\text{\text{\$}12.00}$. Find the median.
...
Sal recorded the amount he spent for gas each week for the past $8$ weeks. The amounts were $\text{\text{\$}38.65},$ $\text{\text{\$}32.18},$ $\text{\text{\$}40.23},$ $\text{\text{\$}51.50},$ $\text{\text{\$}43.68},$ $\text{\text{\$}30.96},$ $\text{\text{\$}41.37},$ and $\text{\text{\$}44.72}.$ Find the median amount.
...
Joaquin gets paid every Friday. His paychecks for the past $8$ Fridays were $\text{\text{\$}315},$ $\text{\text{\$}236.25},$ $\text{\text{\$}236.25},$ $\text{\text{\$}236.25}\ \text{\text{\$}315},$ $\text{\text{\$}315},$ $\text{\text{\$}236.25},$ $\text{\text{\$}393.75}.$ Find the ⓐ mean, ⓑ median, and ⓒ mode.

400. 

The cash register receipts each day last week at a coffee shop were $\text{\text{\$}1,845},$ $\text{\text{\$}1,520},$ $\text{\text{\$}1,438},$ $\text{\text{\$}1,682},$ $\text{\text{\$}1,850},$ $\text{\text{\$}2,721},$ $\text{\text{\$}2,539}.$ Find the ⓐ mean, ⓑ median, and ⓒ mode.
