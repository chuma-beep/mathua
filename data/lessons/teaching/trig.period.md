...
A common mnemonic for remembering these relationships is SohCahToa, formed from the first letters of “ _underline Send underline_ine is _underline oend underline_pposite over _underline hend underline_ypotenuse, _underline Cend underline_osine is _underline aend underline_djacent over _underline hend underline_ypotenuse, _underline Tend underline_angent is _underline oend underline_pposite over _underline aend underline_djacent.”
...
cos(α)= adjacent hypotenuse = 15 17 cos(α)= adjacent hypotenuse = 15 17
...
sinα= opposite α hypotenuse = 4 5 cosα= adjacent to α hypotenuse = 3 5 tanα= opposite α adjacent to α = 4 3 secα= hypotenuse adjacent to α = 5 3 cscα= hypotenuse opposite α = 5 4 cotα= adjacent to α opposite α = 3 4 sinα= opposite α hypotenuse = 4 5 cosα= adjacent to α hypotenuse = 3 5 tanα= opposite α adjacent to α = 4 3 secα= hypotenuse adjacent to α = 5 3 cscα= hypotenuse opposite α = 5 4 cotα= adjacent to α opposite α = 3 4

###  Try It  #2

Using the triangle shown in Figure 7, evaluate  sint, sint, cost, cost, tant, tant, sect, sect, csct, csct, and  cott. cott.
...
sin( π 3 )= opp hyp = 3 s 2s = 3 2 cos( π 3 )= adj hyp = s 2s = 1 2 tan( π 3 )= opp adj = 3 s s = 3 sec( π 3 )= hyp adj = 2s s =2 csc( π 3 )= hyp opp = 2s 3 s = 2 3 = 2 3 3 cot( π 3 )= adj opp = s 3 s = 1 3 = 3 3 sin( π 3 )= opp hyp = 3 s 2s = 3 2 cos( π 3 )= adj hyp = s 2s = 1 2 tan( π 3 )= opp adj = 3 s s = 3 sec( π 3 )= hyp adj = 2s s =2 csc( π 3 )= hyp opp = 2s 3 s = 2 3 = 2 3 3 cot( π 3 )= adj opp = s 3 s = 1 3 = 3 3
...
sint=cos( π 2 −t ). sint=cos( π 2 −t ).

So

cos( π 2 −t )= 5 12 . cos( π 2 −t )= 5 12 .
...
tanθ= opposite adjacent tan(57°)= h 30 Solve for h. h=30tan(57°) Multiply. h≈46.2 Use a calculator. tanθ= opposite adjacent tan(57°)= h 30 Solve for h. h=30tan(57°) Multiply. h≈46.2 Use a calculator.
