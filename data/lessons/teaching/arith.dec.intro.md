...
You probably already know quite a bit about decimals based on your experience with money. Suppose you buy a sandwich and a bottle of water for lunch. If the sandwich costs $\text{\text{\$}3.45}$, the bottle of water costs $\text{\text{\$}1.25}$, and the total sales tax is $\text{\text{\$}0.33}$, what is the total cost of your lunch?

The total is $\text{\text{\$}5.03}.$ Suppose you pay with a $\text{\text{\$}5}$ bill and $3$ pennies. Should you wait for change? No, $\text{\text{\$}5}$ and $3$ pennies is the same as $\text{\text{\$}5.03}.$

Because $\text{100 pennies}=\text{\text{\$}1},$ each penny is worth $\frac{1}{100}$ of a dollar. We write the value of one penny as $\text{\$}0.01,$ since $0.01=\frac{1}{100}.$
...
When we name a whole number, the name corresponds to the place value based on the powers of ten. In Whole Numbers, we learned to read $10,000$ as _ten thousand_. Likewise, the names of the decimal places correspond to their fraction values. Notice how the place value names in Figure 5.2 relate to the names of the fractions from Table 5.2.
...
Remember that $\text{\text{\$}5}.03$ lunch? We read $\text{\text{\$}5.03}$ as _five dollars and three cents_. Naming decimals (those that don’t represent money) is done in a similar way. We read the number $5.03$ as _five and three hundredths_.
...
The number $15.68$ is read _fifteen and sixty-eight hundredths_.
...
---|---  
The word _and_ tells us to place a decimal point. | ___.___  
The word before _and_ is the whole number; write it to the left of the decimal point. | 6._____  
The decimal part is seventeen hundredths.   
Mark two places to the right of the decimal point for hundredths. | 6._ _  
...
Before we move on to our next objective, think about money again. We know that $\text{\text{\$}1}$ is the same as $\text{\text{\$}1.00}.$ The way we write $\text{\text{\$}1}\ (\text{or}\ \text{\text{\$}1.00})$ depends on the context. In the same way, integers can be written as decimals with as many zeros as needed to the right of the decimal.

$\begin{array}{cccc}5=5.0 & & & −2=−2.0 \\ 5=5.00 & & & −2=−2.00 \\ 5=5.000 & & & −2=−2.000\end{array}$

$\text{and so on…}$

### Convert Decimals to Fractions or Mixed Numbers

We often need to rewrite decimals as fractions or mixed numbers. Let’s go back to our lunch order to see how we can convert decimal numbers to fractions. We know that $\text{\text{\$}5.03}$ means $5$ dollars and $3$ cents. Since there are $100$ cents in one dollar, $3$ cents means $\frac{3}{100}$ of a dollar, so $0.03=\frac{3}{100}.$
...
For our $\text{\text{\$}5.03}$ lunch, we can write the decimal $5.03$ as a mixed number.
...
If you think of this as money, you know that $\text{\text{\$}0.40}$ (forty cents) is greater than $\text{\text{\$}0.04}$ (four cents). So,

$0.40>0.04$

In previous chapters, we used the number line to order numbers.

$\begin{array}{c} \\ a<b\ ‘a\ \text{is less than}\ b’\ \text{when}\ a\ \text{is to the left of}\ b\ \text{on the number line} \\ a>b\ ‘a\ \text{is greater than}\ b’\ \text{when}\ a\ \text{is to the right of}\ b\ \text{on the number line}\end{array}$
...
---|---  
| $0.64\ \;\;\;0.6$  
Check to see if both numbers have the same number of decimal places. They do not, so write one zero at the right of 0.6. | $0.64\ \;\;\;0.60$  
...
---|---  
| $0.83\ \;\;\;0.803$  
Check to see if both numbers have the same number of decimal places. They do not, so write one zero at the right of 0.83. | $0.830\ \;\;\;0.803$  
...
In the United States, gasoline prices are usually written with the decimal part as thousandths of a dollar. For example, a gas station might post the price of unleaded gas at $\text{\text{\$}3.279}$ per gallon. But if you were to buy exactly one gallon of gas at this price, you would pay $\text{\text{\$}3.28}$, because the final price would be rounded to the nearest cent. In Whole Numbers, we saw that we round numbers to get an approximate value when the exact value is not needed. Suppose we wanted to round $\text{\text{\$}2.72}$ to the nearest dollar. Is it closer to $\text{\text{\$}2}$ or to $\text{\text{\$}3}?$ What if we wanted to round $\text{\text{\$}2.72}$ to the nearest ten cents; is it closer to $\text{\text{\$}2.70}$ or to $\text{\text{\$}2.80}?$ The number lines in Figure 5.4 can help us answer those questions.
...
**Salary Increase** Danny got a raise and now makes $\text{\text{\$}58,965.95}$ a year. Round this number to the nearest:
...
**New Car Purchase** Selena’s new car cost $\text{\text{\$}23,795.95}.$ Round this number to the nearest:
...
**Sales Tax** Hyo Jin lives in San Diego. She bought a refrigerator for $\text{\text{\$}1624.99}$ and when the clerk calculated the sales tax it came out to exactly $\text{\text{\$}142.186625}.$ Round the sales tax to the nearest ⓐ penny ⓑ dollar.

90. 

**Sales Tax** Jennifer bought a $\text{\text{\$}1,038.99}$ dining room set for her home in Cincinnati. She calculated the sales tax to be exactly $\text{\text{\$}67.53435}.$ Round the sales tax to the nearest ⓐ penny ⓑ dollar.
