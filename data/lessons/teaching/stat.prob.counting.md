...
1.  Step 1. Write the formula for the mean
    ``` math
    \text{mean} = \frac{\text{sum of values in data set}}{n}
    ```
...
Last week Ray recorded how much he spent for lunch each workday. He spent $\text{\$6.50},\text{\$7.25},\text{\$4.90},\text{\$5.30},\text{and}\ \text{\$12.00}.$ Find the mean of how much he spent each day.

### Try It 5.102

Lisa has kept the receipts from the past four trips to the gas station. The receipts show the following amounts: $\text{\$34.87},\text{\$42.31},\text{\$38.04},\text{and}\ \text{\$43.26}.$ Find the mean.
...
Dora is in the middle of the group. Her height, $65\text{''},$ is the *median* of the girls’ heights. Half of the heights are less than or equal to Dora’s height, and half are greater than or equal. The median is the middle value.
...
{\text{Probability of choosing a banana} = 0.6}
\end{array}
$$
