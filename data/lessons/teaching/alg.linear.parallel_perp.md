...
We learned in  the section  that all lines can be written in  standard form . When either $A$ or $B$ equal $0$, we end up with a horizontal or vertical line. Let's take the standard form line equation, $Ax+By=C$, and one at a time let $A=0$ and $B=0$ and simplify each equation.

$$
\begin{aligned}Ax+By&=C& Ax+By&=C \\ \substitute{0}x+By&=C& Ax+\substitute{0}y&=C \\ By&=C& Ax&=C \\ y&=\divideunder{C}{B}& x&=\divideunder{C}{A} \\ y&=k& x&=h\end{aligned}
$$

At the end we just renamed the constant numbers $\frac{C}{B}$ and $\frac{C}{A}$ to $k$ and $h$ because of tradition. What is important, is that you view $h$ and $k$ (as well as $A$, $B$, and $C$) as constants: numbers that have some specific value and don't change.
...
In  the exercise , we learned that a horizontal line's slope is $0$, because the $y$-values don't change as time moves on. So the numerator in the  slope formula  is $0$. Now, if we know a line's slope and its $y$-intercept, we can use  slope-intercept form  to write its equation:

$$
\begin{aligned}y&=mx+b \\ y&=0x+b \\ y&=b\end{aligned}
$$

This gives us an alternative way to think about equations of horizontal lines. They have a certain $y$-intercept $b$, and they have slope $0$.
...
What is the slope of a vertical line?  the figure  shows three lines passing through the origin, each steeper than the last. In each graph, you can see a slope triangle that uses a "run" of $1$ unit.
...
Well, there is no getting around the fact that $x=650$. As for $y$, without any extra information about your viewing habits, it could theoretically be as low as $0$ or it could be anything larger than that. If we graph this scenario, we have to graph the equation $x=650$ which we now know to give a vertical line, and we get  the figure .

*&#xA;&#x20;         New TV: hours watched versus purchase price; negative $y$-values omitted since they
...
The slopes of two perpendicular lines have a special relationship too.  the figure  walks you through an explanation of this relationship.

*The relationship between slopes of perpendicular lines*

When the first line in  the figure  has slope $m$, the second has slope
...
Another way to say this is that the product of the slopes of two perpendicular lines is $-1$ (assuming both of the lines have a slope in the first place). That is, if there are two perpendicular lines and we let $m_1$ and $m_2$ represent their slopes, then $m_1\cdot m_2=-1$.

Here are three pairs of perpendicular lines where we can see if the pattern holds.

*&#xA;&#x20;         $y=2x-2$ and $y=-\frac{1}{2}x+2$. Note the relationship between their
&#x20;         slopes: $2\cdot-\frac{1}{2}=-1$
&#x20;      &#x20;*

*&#xA;&#x20;         $y=-3x+4$ and $y=\frac{1}{3}x-3$. Note the relationship between their
&#x20;         slopes: $-3\cdot\frac{1}{3}=-1$
&#x20;      &#x20;*

*&#xA;&#x20;         $y=x$ and $y=-x$. Note the relationship between their slopes:
&#x20;         $1\cdot-1=-1$
&#x20;      &#x20;*
...
$$
\begin{aligned}\text{Line }A\text{'s slope}&=\frac{y_2-y_1}{x_2-x_1}&\text{Line }B\text{'s slope}&=\frac{y_2-y_1}{x_2-x_1} \\ &=\frac{-10-10}{3-(-2)}&&=\frac{-1-(-4)}{8-(-4)} \\ &=\frac{-20}{5}&&=\frac{3}{12} \\ &=-4&&=\frac{1}{4}\end{aligned}
$$
